import { castChunks, type SyntaxNode } from "../parsing/cast.js"
import { fallbackChunks } from "../parsing/fallback.js"
import { createSourceIndex, type SourceIndex } from "../parsing/range.js"
import type { ChunkRecord, SymbolRecord } from "../shared/types.js"
import { assignSymbolsToChunks, attachTopology, extractSymbols } from "../topology/index.js"
import { embedChunks } from "./batching.js"
import type {
  CreateIndexerInput,
  EmbeddingBatcher,
  FileResultWriter,
