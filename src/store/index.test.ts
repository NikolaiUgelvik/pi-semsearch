...
import type { CastIndex, ChunkRecord, FileRecord, LexicalChunkCandidate, SymbolRecord } from "../shared/types.js"
import { cosineSimilarity, createEmptyIndex, createIndexStore, searchVectors } from "./index.js"
...
describe("index store", () => {
  ...
  test("sqlite vector candidates do not use the full vector JSON scan path", async () => {
    const source = await readFile(new URL("./vector-search.ts", import.meta.url), "utf8")
