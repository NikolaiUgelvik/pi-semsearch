import type { ChunkRecord, FileRecord, LexicalIndex, SymbolRecord } from "../shared/types.js";
import type { SqliteDatabase as Database } from "./db.js";
import type { SourceHydrationContext, SourceReadResult, StoredChunkRecord } from "./types.js";
...
declare function readRunMetadata(db: Database, runId: string): import("../shared/types.js").IndexMetadata | undefined;
