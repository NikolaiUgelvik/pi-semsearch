...
import { formatThrownError, IndexUnavailableError, isStoreUnavailableError } from "./extension-errors.js";
import { appendSearchDiagnostic, ensureSearchIndexReady, INDEX_REFRESH_IN_PROGRESS_DIAGNOSTIC, queueInitialRefresh, rerankDocuments, } from "./extension-index-ready.js";
import { serializeChunkLookupToolOutput, serializeSearchToolOutput, unavailableToolResult } from "./extension-output.js";
import { resolveWorktreePath, worktreeRelativePath } from "./extension-paths.js";
import { addRunStoreMethods, createProjectId, hasHydrateChunksStore, hasLexicalCandidateStore, hasReadMetadataStore, hasVectorCandidateStore, hydratedChunkSetToIndex, } from "./extension-store.js";
