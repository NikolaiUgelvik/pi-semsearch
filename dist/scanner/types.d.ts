...
import type { CastIndex, ChunkingOptions, ChunkRecord, DiagnosticRecord, FileRecord, SymbolRecord } from "../shared/types.js";
...
type IndexRunStore = ScannerStore & Required<Pick<ScannerStore, "beginIndexRun" | "getCompletedFile" | "writeFileResult" | "activateRun">>;
...
export type { CreateIndexerInput, EmbeddingBatcher, EmbeddingResult, FileResultWriter, FileStatMetadata, IndexRunStore, LoadedFile, RefreshState, ScannerFileResult, ScannerStore, SymbolsByFilePath, };
